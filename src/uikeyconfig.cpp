...
void UiKeyConfig::Init(bool p_MapKeys)
{
  const std::map<std::string, std::string> defaultConfig =
  {
    ...
    { "vim_navigation_left", "h" },
    { "vim_navigation_right", "l" },
    { "vim_navigation_next", "j" },
    { "vim_navigation_prev", "k" },
    { "vim_navigation_unread", "," },
    { "vim_navigation_delete_msg", "d" },
    { "vim_navigation_save", "s" },
    { "vim_navigation_open", "l" },
    { "vim_navigation_open_link", "u" },
    { "vim_navigation_edit_msg", "e" },
    { "vim_navigation_copy", "y" },
    { "vim_navigation_paste", "p" },
    { "vim_navigation_jump_quoted", "g" },
    { "vim_navigation_forward_msg", "f" },
    { "vim_navigation_react", "r" },
    { "vim_navigation_open_msg", "w" },
    { "vim_navigation_end", "m" },
    { "vim_navigation_focus_entry", "i" },
    { "vim_navigation_focus_history", "\33" },
    { "vim_navigation_focus_list", "KEY_TAB" },
    { "vim_navigation_quit", "q" },
    { "vim_navigation_find", "/" },
    { "vim_navigation_find_next", "n" },
    { "vim_navigation_select_contact", "o" },
