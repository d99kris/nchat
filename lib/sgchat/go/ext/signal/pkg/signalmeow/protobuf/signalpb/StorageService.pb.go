...
const (
	...
	ManifestRecord_Identifier_STICKER_PACK            ManifestRecord_Identifier_Type = 6
...
const (
	AccountRecord_UNKNOWN_BADGE_TYPE AccountRecord_UnreadBadgeType = 0 // Interpret as "Unread messages"
	AccountRecord_UNREAD_MESSAGES    AccountRecord_UnreadBadgeType = 1
	AccountRecord_UNREAD_CHATS       AccountRecord_UnreadBadgeType = 2
)

// Enum value maps for AccountRecord_UnreadBadgeType.
var (
	AccountRecord_UnreadBadgeType_name = map[int32]string{
		0: "UNKNOWN_BADGE_TYPE",
		1: "UNREAD_MESSAGES",
		2: "UNREAD_CHATS",
	}
	AccountRecord_UnreadBadgeType_value = map[string]int32{
...
func (x AccountRecord_UnreadBadgeType) Enum() *AccountRecord_UnreadBadgeType {
	p := new(AccountRecord_UnreadBadgeType)
	*p = x
	return p
}

func (x AccountRecord_UnreadBadgeType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}
...
func (x *StorageRecord) GetStickerPack() *StickerPackRecord {
	if x != nil {
		if x, ok := x.Record.(*StorageRecord_StickerPack); ok {
...
type StorageRecord_StickerPack struct {
	StickerPack *StickerPackRecord `protobuf:"bytes,6,opt,name=stickerPack,proto3,oneof"`
}
...
func (*StorageRecord_StickerPack) isStorageRecord_Record() {}
...
func (x *ContactRecord) GetBlockedAtTimestamp() uint64 {
	if x != nil {
...
func (x *ContactRecord) GetNotifyForCallsIfMuted() OptionalBool {
	if x != nil {
...
func (x *ContactRecord) GetShowUnreadReminders() OptionalBool {
	if x != nil {
...
type GroupV2Record struct {
	...
	MarkedUnread                 bool                        `protobuf:"varint,5,opt,name=markedUnread,proto3" json:"markedUnread,omitempty"`
	MutedUntilTimestamp          uint64                      `protobuf:"varint,6,opt,name=mutedUntilTimestamp,proto3" json:"mutedUntilTimestamp,omitempty"`
	DontNotifyForMentionsIfMuted bool                        `protobuf:"varint,7,opt,name=dontNotifyForMentionsIfMuted,proto3" json:"dontNotifyForMentionsIfMuted,omitempty"` // will be deprecated in favor of [notifyForMentionsIfMuted]
	...
	BlockedAtTimestamp           uint64                      `protobuf:"varint,13,opt,name=blockedAtTimestamp,proto3" json:"blockedAtTimestamp,omitempty"`                                             // 0 means the blocked time is unknown
	NotifyForCallsIfMuted        OptionalBool                `protobuf:"varint,14,opt,name=notifyForCallsIfMuted,proto3,enum=signalservice.OptionalBool" json:"notifyForCallsIfMuted,omitempty"`       // If unset, use the default settings
	NotifyForMentionsIfMuted     OptionalBool                `protobuf:"varint,15,opt,name=notifyForMentionsIfMuted,proto3,enum=signalservice.OptionalBool" json:"notifyForMentionsIfMuted,omitempty"` // If unset, use the default settings. If [dontNotifyForMentionsIfMuted] is true, this should be initialized to false.
	NotifyForRepliesIfMuted      OptionalBool                `protobuf:"varint,16,opt,name=notifyForRepliesIfMuted,proto3,enum=signalservice.OptionalBool" json:"notifyForRepliesIfMuted,omitempty"`   // If unset, use the default settings
	ShowUnreadReminders          OptionalBool                `protobuf:"varint,17,opt,name=showUnreadReminders,proto3,enum=signalservice.OptionalBool" json:"showUnreadReminders,omitempty"`           // If unset, use the default settings
	unknownFields                protoimpl.UnknownFields
	sizeCache                    protoimpl.SizeCache
}
...
func (x *GroupV2Record) GetBlockedAtTimestamp() uint64 {
	if x != nil {
		return x.BlockedAtTimestamp
	}
	return 0
...
func (x *GroupV2Record) GetNotifyForCallsIfMuted() OptionalBool {
	if x != nil {
		return x.NotifyForCallsIfMuted
	}
	return OptionalBool_UNSET
...
func (x *GroupV2Record) GetNotifyForMentionsIfMuted() OptionalBool {
	if x != nil {
...
func (x *GroupV2Record) GetNotifyForRepliesIfMuted() OptionalBool {
	if x != nil {
...
func (x *GroupV2Record) GetShowUnreadReminders() OptionalBool {
	if x != nil {
		return x.ShowUnreadReminders
	}
	return OptionalBool_UNSET
...
type AccountRecord struct {
	...
	ReleaseNotesChatBlockedAt           *uint64                                          `protobuf:"varint,52,opt,name=releaseNotesChatBlockedAt,proto3,oneof" json:"releaseNotesChatBlockedAt,omitempty"`                         // only set if known (>0)
	UnreadBadgeType                     AccountRecord_UnreadBadgeType                    `protobuf:"varint,53,opt,name=unreadBadgeType,proto3,enum=signalservice.AccountRecord_UnreadBadgeType" json:"unreadBadgeType,omitempty"`  // Only used in desktop/ios
	IncludeMutedChatsInBadge            OptionalBool                                     `protobuf:"varint,54,opt,name=includeMutedChatsInBadge,proto3,enum=signalservice.OptionalBool" json:"includeMutedChatsInBadge,omitempty"` // Only used in desktop/ios. If unset, consider this off. Only used in desktop/ios
	ReactionNotifications               OptionalBool                                     `protobuf:"varint,55,opt,name=reactionNotifications,proto3,enum=signalservice.OptionalBool" json:"reactionNotifications,omitempty"`       // If unset, consider this on
	NotifyForCallsIfMuted               OptionalBool                                     `protobuf:"varint,56,opt,name=notifyForCallsIfMuted,proto3,enum=signalservice.OptionalBool" json:"notifyForCallsIfMuted,omitempty"`       // If unset, consider this off
	NotifyForMentionsIfMuted            OptionalBool                                     `protobuf:"varint,57,opt,name=notifyForMentionsIfMuted,proto3,enum=signalservice.OptionalBool" json:"notifyForMentionsIfMuted,omitempty"` // If unset, consider this on
	NotifyForRepliesIfMuted             OptionalBool                                     `protobuf:"varint,58,opt,name=notifyForRepliesIfMuted,proto3,enum=signalservice.OptionalBool" json:"notifyForRepliesIfMuted,omitempty"`   // If unset, consider this on
	ShowUnreadReminders                 OptionalBool                                     `protobuf:"varint,59,opt,name=showUnreadReminders,proto3,enum=signalservice.OptionalBool" json:"showUnreadReminders,omitempty"`           // If unset, consider this on
	NotifyWhenContactJoins              OptionalBool                                     `protobuf:"varint,60,opt,name=notifyWhenContactJoins,proto3,enum=signalservice.OptionalBool" json:"notifyWhenContactJoins,omitempty"`     // If unset, consider this off
	unknownFields                       protoimpl.UnknownFields
	sizeCache                           protoimpl.SizeCache
}
...
func (x *AccountRecord) GetReleaseNotesChatBlockedAt() uint64 {
	if x != nil && x.ReleaseNotesChatBlockedAt != nil {
		return *x.ReleaseNotesChatBlockedAt
	}
	return 0
}

func (x *AccountRecord) GetUnreadBadgeType() AccountRecord_UnreadBadgeType {
	if x != nil {
		return x.UnreadBadgeType
	}
	return AccountRecord_UNKNOWN_BADGE_TYPE
}

func (x *AccountRecord) GetIncludeMutedChatsInBadge() OptionalBool {
	if x != nil {
...
func (x *AccountRecord) GetReactionNotifications() OptionalBool {
	if x != nil {
...
func (x *AccountRecord) GetNotifyForCallsIfMuted() OptionalBool {
	if x != nil {
		return x.NotifyForCallsIfMuted
	}
	return OptionalBool_UNSET
...
func (x *AccountRecord) GetNotifyForMentionsIfMuted() OptionalBool {
	if x != nil {
		return x.NotifyForMentionsIfMuted
	}
	return OptionalBool_UNSET
...
func (x *AccountRecord) GetNotifyForRepliesIfMuted() OptionalBool {
	if x != nil {
		return x.NotifyForRepliesIfMuted
	}
	return OptionalBool_UNSET
...
func (x *AccountRecord) GetShowUnreadReminders() OptionalBool {
	if x != nil {
		return x.ShowUnreadReminders
	}
	return OptionalBool_UNSET
...
func (x *AccountRecord) GetNotifyWhenContactJoins() OptionalBool {
	if x != nil {
...
type StickerPackRecord struct {
	...
	//
	// )
	Position uint32 `protobuf:"varint,3,opt,name=position,proto3" json:"position,omitempty"` // When displayed sticker packs should be first sorted
	...
	// `position`.
	DeletedAtTimestamp uint64 `protobuf:"varint,4,opt,name=deletedAtTimestamp,proto3" json:"deletedAtTimestamp,omitempty"` // Timestamp in milliseconds. When present and
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
func (x *StickerPackRecord) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *StickerPackRecord) GetPackKey() []byte {
	if x != nil {
		return x.PackKey
	}
	return nil
...
func (x *StickerPackRecord) GetPosition() uint32 {
	if x != nil {
		return x.Position
	}
	return 0
...
func (x *StickerPackRecord) GetDeletedAtTimestamp() uint64 {
	if x != nil {
		return x.DeletedAtTimestamp
	}
	return 0
...
var file_signalpb_StorageService_proto_goTypes = []any{
	...
	(AccountRecord_UnreadBadgeType)(0),                      // 5: signalservice.AccountRecord.UnreadBadgeType
	(AccountRecord_PhoneNumberSharingMode)(0),               // 6: signalservice.AccountRecord.PhoneNumberSharingMode
	(AccountRecord_UsernameLink_Color)(0),                   // 7: signalservice.AccountRecord.UsernameLink.Color
	(ChatFolderRecord_FolderType)(0),                        // 8: signalservice.ChatFolderRecord.FolderType
	(NotificationProfile_DayOfWeek)(0),                      // 9: signalservice.NotificationProfile.DayOfWeek
	(*StorageManifest)(nil),                                 // 10: signalservice.StorageManifest
	(*StorageItem)(nil),                                     // 11: signalservice.StorageItem
	(*StorageItems)(nil),                                    // 12: signalservice.StorageItems
	(*ReadOperation)(nil),                                   // 13: signalservice.ReadOperation
	(*WriteOperation)(nil),                                  // 14: signalservice.WriteOperation
	(*ManifestRecord)(nil),                                  // 15: signalservice.ManifestRecord
	(*StorageRecord)(nil),                                   // 16: signalservice.StorageRecord
	(*ContactRecord)(nil),                                   // 17: signalservice.ContactRecord
	(*GroupV1Record)(nil),                                   // 18: signalservice.GroupV1Record
	(*GroupV2Record)(nil),                                   // 19: signalservice.GroupV2Record
	(*Payments)(nil),                                        // 20: signalservice.Payments
